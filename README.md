...
If this userstyle looks like [this](/images-uncompressed/screenshots/error.png?raw=true), you're probably using RES Night-Mode and should disable it. I fixed at least the most broken stuff for Night-Mode but I'm not planning to style for Night-Mode. Especially not since I'm planning to remake this userstyle, this time with a dark and light theme and some other changes.
